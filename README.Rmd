...
จุดมุ่งหมายของ R package นี้ เพื่อให้สามารถ**สร้าง PDF เป็นภาษาไทย :thailand: จาก R Markdown ได้โดยง่าย** จาก **R Markdown template** และ **LaTeX preamble** ที่มีการตั้งค่าสำหรับภาษาไทยมาให้
