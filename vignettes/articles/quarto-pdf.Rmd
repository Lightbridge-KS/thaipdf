---
title: "Quarto in Thai language to PDF"
---
...
Quarto สามารถ render เป็น HTML, MS Word ได้ทันที แต่สำหรับ **PDF จะต้องมีการ setup เพิ่มเติม** ซึ่งจะอธิบายวิธีการในบทความนี้

**โดยสรุป:** หลักการคือ **แทรก LaTeX preamble ที่มีการตั้งค่าภาษาไทย** เข้าไป ก่อนที่ LaTeX จะ compile นั่นเอง

## Example

ในที่นี้จะแนะนำการสร้าง [Quarto Book](https://quarto.org/docs/books/) ที่มีภาษาไทย โดย render เป็น PDF

โดยผมได้สร้าง repository เป็นตัวอย่างไว้: [**Example Thai Quarto Book Repository**](https://github.com/Lightbridge-KS/quarto-book-thai-pdf) ซึ่งเป็นรูปแบบ [Quarto Book](https://quarto.org/docs/books/) โดยหลักการเดียวกันสามารถใช้สำหรับ single document ได้ด้วย 

สามารถดูผลลัพท์ที่ render แล้วได้จาก:
...
จะสร้างไฟล์ `thai-preamble.tex` ที่ตั้งค่า font เป็น "TH Sarabun New" มาให้ (สามารถเปลี่ยนเป็น font อื่นได้ที่ `thai_font` argument)
...
จากนั้นสามารถใช้ภาษาไทยและ render เป็น PDF ได้เลย จากตัวอย่างจะได้ผลลัพท์ PDF เป็น [**PDF Book in Thai**](./docs/Quarto-Book-ไทย.pdf)
