...
Link ไปยัง web page ใช้ syntax: `[text](url)`

-   [ฺBookdown](https://bookdown.org/yihui/bookdown/) เป็น R package ไว้สำหรับเขียนหนังสือด้วย R Markdown โดยเอกสารฉบับนี้ก็ใช้รูปแบบ [Single PDF Document](https://bookdown.org/yihui/bookdown/a-single-document.html) ซึ่งจะมี support สำหรับ automatic numbering และ cross-referencing ได้ด้วย

Cross reference ไปยัง section แบบนี้
